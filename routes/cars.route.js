...
router.get("/carGearSubmodel/:sub_model_id", carsController.getAllGearBySubModel); 
...
router.get("/carYearSubmodel/:sub_model_id", carsController.getAllYearBySubModel); 
